$(function () {
        ...
        columns: [
            ...
            { data: 'nome' },
            {
                render: function (data, type, row) {
                    ...
                    data-id="' + row.id + '">Editar</button>\<button class="btn btn-danger botao-apagar" data-id="' + row.id + '">Apagar</button';
                }
            }
        ]
    });
    ...
    $('.table').on('click', '.botao-editar', function () {
        ...
        $.ajax({
            ...
            error: function (error) {
                alert('Não foi possível carregar a modal');
            }
        })
    });
})